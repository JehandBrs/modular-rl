...
class DecoderBase(nn.Module):
    ...
    def forward(self, obs_z, act_z, obs, act=None):
        ...
        if self.is_critic:
            ...
            # If not a critic network, we only pass actuator embeddings to the tranformer decoder
            n_act_z = act_z
        ...
        # At the output of the transformer decoder, we concat with the actuators embeddings
