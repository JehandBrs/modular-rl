...
class VariationalPolicy(ActorGraphPolicy):
    ...
    def forward(self, state, mode="train"):
        ...
        # act_embedding = self.act_embeddings(self.action_ids[self.action_ids!=0])
        ...
        #     self.num_limbs-1, 1, self.latent_size)
        # act_embedding = act_embedding.expand(
        #     self.num_limbs-1, self.batch_size, self.latent_size)
